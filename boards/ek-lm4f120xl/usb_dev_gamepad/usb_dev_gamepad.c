...
#include "usb_dev_gamepad_structs.h"
...
//!
//! This example application turns the evaluation board into a gamepad.
//  This utilizes usbhidcustom.c file which allows you to easily create custom devices (including combination HID devices)
//! Pressing the Left and right launchpad buttons will influence the state of the buttons and controls (Use config utility to view)
//! Make sure your usbhidcustom.c file has the gamepad example descriptor below configured and the .h file has the correct descriptor size (6)
/*
