...
//
//****************************************************************************
#define LEDOn()  ROM_GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1,2)
#define LEDOff() ROM_GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1,0)
#define LEDToggle()                                                         \
    ROM_GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1,                           \
                     (ROM_GPIOPinRead(GPIO_PORTF_BASE, GPIO_PIN_1) ^        \
                                      GPIO_PIN_1));
